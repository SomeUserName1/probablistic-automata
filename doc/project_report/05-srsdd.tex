...
\end{verbatim}
    ...
    \section{Algorithm Test Cases}
        \subsection{Weighted Automata}\label{wa_ex}
            ...
            All steps were performed using the Matlab script found in \mintinline{c}{src/test/WA_kiefer.m}. \\
       ...
       \]
        ...
        Additional checks, that this is indeed the same automaton can be found in the output of the Matlab script using the \mintinline{matlab}{probe_and_display()} function. 
        \newpage
       ...
       \]
        ...
        Additional checks, that this is indeed the same automaton can be found in the output of the Matlab script using the \mintinline{matlab}{probe_and_display()} function. \hfill $\blacksquare$
        \newpage
